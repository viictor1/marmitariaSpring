...
INSERT INTO menu (name, price, discount, active, description) values ('P', 18, 2, true, 'marmita do tamanho P');
INSERT INTO menu (name, price, discount, active, description) values ('M', 20, 2, true, 'marmita do tamanho M');
INSERT INTO menu (name, price, discount, active, description) values ('G', 22, 2, true, 'marmita do tamanho G');